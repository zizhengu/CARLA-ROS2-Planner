...
class Agent(CompatibleNode):
    ...
    def get_waypoint(self, location):
        ...
        geometry_msgs/Point -> carla_msgs/Waypoint
        request->location -> request->waypoint
    ...
    def _is_vehicle_hazard(self, ego_vehicle_pose, objects):
        ...
        :type ego_vehicle_pose: geometry_msgs/Pose   这里应该是geometry_msgs/msg/Pose
    ...
    def _is_light_red(self, ego_vehicle_pose, lights_status, lights_info):
        ...
        :param lights_status: list containing all traffic light status. 交通灯的状态
        :type lights_status: carla_msgs/CarlaTrafficLightStatusList

        :param lights_info: list containing all traffic light info. 交通灯的位姿信息和触发空间
